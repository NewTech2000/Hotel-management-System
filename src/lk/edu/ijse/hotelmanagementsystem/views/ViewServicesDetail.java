 ...
 * @author USER
 */
public class ViewServicesDetail extends javax.swing.JFrame {
    ...
    public void coman(){
        ...
        dtmServ = (DefaultTableModel) tblRoom.getModel();
    ...
    private void loadDataServ() {
        ...
        try {
            ...
            Logger.getLogger(ViewServicesDetail.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        lblStep8.setText("Services Detail");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewServicesDetail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
