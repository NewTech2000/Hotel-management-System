 ...
 * @author USER
 */
public class ViewCustomerDetail extends javax.swing.JFrame {
    ...
    public void coman(){
        ...
        tblCustomer.getTableHeader().setFont(this.getFont().deriveFont(Font.BOLD));
    }
...
//                String first =customer.getFName();
//                String last =customer.getLName();
//                String all =first+""+last;
            ...
            Logger.getLogger(ViewCustomerDetail.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        tblCustomer.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cust. ID", "Last  Name", "First  Name", "E-Mail", "Address", "pasport Num.", "Country", "NIC", "Mobile Number"
            }
        ));
        ...
        lblStep8.setText("Customer Detail");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCustomerDetail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
